...
S3FDP_OPTS="${S3FDP_OPTS:-lowering-mode=specialized target-frequency=5e7 specializations=enable=s3fdp,s3fdp.ovf=10,s3fdp.msb=122,s3fdp.lsb=-133,s3fdp.chunk_size=16,s3fdp.we=8,s3fdp.wf=7}"
